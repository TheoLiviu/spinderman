...
healthbar= Group(Oval(315,10,14,20, rotateAngle=-30, fill='red'),
...
def onKeyHold(keys):
    ...
    elif'w'in keys and player.centerX>app.x and player.centerY>app.y:
    ...
    if 'space' in keys and player.centerY>app.y:
